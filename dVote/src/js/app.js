App = {
    ...
    initWeb3: function() {
        ...
        web3 = new Web3(new Web3.providers.HttpProvider("http://13.229.142.47:8545"));
    ...
    render: function() {
        ...
        if (App.account == '0x0') {
            ...
            App.account = window.prompt("Enter the Account", "");
        ...
        App.contracts.Election.deployed().then(function(instance) {
            ...
            electionInstance.curVoters().then(function(jumlahVote) {
                ...
                for (var i = 0; i < jumlahVotes; i++) {
                    console.log(count++);
                    electionInstance.voterList(i).then(function(list) {
            ...
            for (var i = 1; i <= candidatesCount; i++) {
                electionInstance.candidates(i).then(function(candidate) {
                    ...
                    if (id == 1) {
                        var candidateTemplate = '<div class="col-md-6 col-lg-4"> <div class="card mx-30"> <img src="https://cdn1-production-images-kly.akamaized.net/P85Ddv6JF2FbVJeoCgCelmhtt4U=/640x360/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/1439641/original/042027300_1482131661-reddit.jpg" style="height: 110px;" class="card-img-top" alt="..."> <div class="card-body"> <h5 class="card-title" style="text-align:center;">' + name + '</h5> <h6 style="text-align:center;"> Vote: ' + voteCount + '</h6> <p class="card-text"> Perwakilan dari desa Konoha <div class="socials"> </div> </div> </div> </div>'
                        candidatesResults.append(candidateTemplate);
                    } else if (id == 2) {
                        var candidateTemplate = '<div class="col-md-6 col-lg-4"> <div class="card mx-30"> <img src="https://cdn.idntimes.com/content-images/duniaku/post/20191008/naruto-sasuke-uchiha-kecil-be340da3b7c782e66836584d5940ea73.jpg" style="height: 110px;" class="card-img-top" alt="..."> <div class="card-body"> <h5 class="card-title" style="text-align:center;">' + name + '</h5> <h6 style="text-align:center;"> Vote: ' + voteCount + '</h6> <p class="card-text">  Perwakilan dari kota Binjai <div class="socials"> </div> </div> </div> </div>'
                        candidatesResults.append(candidateTemplate);
                    } else {
                        var candidateTemplate = '<div class="col-md-6 col-lg-4"> <div class="card mx-30"> <img src="https://cdn.sindonews.net/dyn/620/content/2017/10/04/158/1245189/kakashi-hatake-bakal-punya-pacar-di-anime-boruto-2Qd-thumb.jpg" style="height: 110px;"  class="card-img-top" alt="..."> <div class="card-body"> <h5 class="card-title" style="text-align:center;">' + name + '</h5> <h6 style="text-align:center;"> Vote: ' + voteCount + '</h6> <p class="card-text">  Perwakilan dari Bogor <div class="socials"> </div> </div> </div> </div>'
                        candidatesResults.append(candidateTemplate);
                    }
    ...
    castVote: function() {
        ...
        App.contracts.Election.deployed().then(function(instance) {
            return instance.vote(candidateId, { from: App.account, gas: '1000000' });
